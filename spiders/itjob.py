...
from itjob.items import *
#from itjob.misc.log import *
class itjboSpider(CrawlSpider):
    name = "51job"
    allowed_domains = ["51job.com"]
    start_urls = [
        "http://my.51job.com/my/My_Pmc.php"
    ]
    rules = ( # 定义爬取URL的规则
        Rule(sle(allow=("/My_Pmc.php\?&start=\d{,6}#a")), follow=True, callback='parse_item')
    )
